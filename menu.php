                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="catalogo" class="collapse">
                            ...
                            <li>
                                <a href="cliente.interfaz.php">Clientes</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul id="demo2" class="collapse">
                            ...
                            <li>
                                ...
                                <a href="cotizaciones.php">Cancelar Venta</a>
                                <a href="cotizaciones.php">Reporte de ventas</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            ...
                            <li>
                                <a href="traspaso.php">Traspaso Salida</a>
                                <a href="traspaso.php">Confirmar entrada</a>
                                <a href="traspaso.php">Solicitar Mercancia</a>
                                <a href="traspaso.php">Reporte de Traspasos</a>
                    ...
                    <li>
                        ...
                        <ul id="demo3" class="collapse">
                            <li>
                                <a href="personal.php">Empleados</a>
                            </li>
                            <li>
