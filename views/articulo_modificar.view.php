                ...
                <div class="col-lg-9">     
                    ...
                    <div class="login-panel panel panel-info">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" action="modif.php" method="POST" name="modificar_producto">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name= "medida" id="medida" placeholder="Medida" value="<?php echo $resultado[0]['descripcion'];?>">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="col-sm-3 form-control" name= "precio_venta" id="precio_venta" placeholder="Precio Venta" value="<?php echo $resultado[0]['precio_venta'];?>">
                                                </div>
                                               
                                            </div>

                                            <input type="hidden" name="id" value="<?php echo $resultado[0]['idarticulo'];?>">
