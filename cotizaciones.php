...
$sql= 
$statement = $objData->prepare("SELECT articulo.idarticulo, articulo.descripcion, articulo.precio_venta, factura_has_articulo.cantidad FROM articulo, factura_has_articulo WHERE articulo.idarticulo = factura_has_articulo.Articulo_idarticulo;
");
$statement->execute();
