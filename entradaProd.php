    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
								...
								<div class="col-md-12">
									<div class="breadcrumb">
										<div class="form-group">
											<label for="inputMedida" class="col-sm-2 control-label">Proveedor </label>
										    <div class="col-sm-6">
										      	<input type="text" class="form-control" id="inputMedida" placeholder="Buscar por Codigo">
										    </div>
				...
				<!-- FORMULARIO PARA BUSCAR ARTICULOS -->
				<div class="row">
					<div class="col-lg-10 col-lg-offset-1">
						<form class="form-horizontal" name= "contacto" method ="POST" action="mail.php" id="contacto" onsubmit="return enviar()">
							<div class="row">
								...
								<div class="col-md-12">
									<div class="breadcrumb">
										<div class="form-group">
										    ...
										    <div class="col-sm-6">
										      	<input type="text" class="form-control" id="inputMedida" placeholder="Medida">
										    </div>
										    <button type="submit" class="col-sm-3 btn btn-success">
					...
					<form class="form-horizontal" name= "contacto" method ="POST" action="mail.php" id="contacto" onsubmit="return enviar()">
						<div class="row">
							...
							<div class="col-md-12 well">
								...
								<div class="form-group">
									<label for="inputMedida" class="col-sm-2 control-label">Precio: </label>
								    <div class="col-sm-6">
								      	<input type="text" class="col-sm-3 form-control" id="inputMedida" placeholder="Medida">
								    </div>
